...
<html>
        ...
        <div class="columns2">
		 <h2 style="text-align-last: center;"><?php if($row["role"]=="trainer"){echo "TRAINER";}else{echo "MEMBER";} ?></h2>
			<ul>
        		<li>User name : <i><?php   echo  $row1["login_id"] ?></i></li><br>
				<li>Name : <i><?php   echo  $row1["fname"] ." ". $row1["lname"] ?></i></li><br>
				<li>Email Address : <i><?php   echo  $row1["email"] ?></i><li><br>
				<li>Address : <i><?php   echo $row1["address"] ?></i></li><br>
				<li>D.O.B : <i><?php   echo $row1["date_of_birth"] ?></i></li><br>
				<li>Height : <i><?php   echo $row1["height"] ?></i></li><br>
				<li>Weight: <i><?php   echo $row1["weight"] ?></i></li><br>
			</ul>	
